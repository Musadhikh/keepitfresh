# KeepItFresh – AI Coding Guide

## Purpose
This document serves as a **meta-guideline for AI coding assistants** working on the KeepItFresh project.  
It defines how code should be structured, named, and organized — not what frameworks or libraries to use.  
...
- Previews should provide meaningful sample data and/or required mock dependencies.
...
> 📘 This document defines **how to write code**, not **how to implement features**.
