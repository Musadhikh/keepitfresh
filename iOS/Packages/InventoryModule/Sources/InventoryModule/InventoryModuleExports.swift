...
public typealias InventorySyncRetryPolicy = InventoryApplication.InventorySyncRetryPolicy
public typealias DefaultInventorySyncRetryPolicy = InventoryApplication.DefaultInventorySyncRetryPolicy
public typealias InventorySyncObservability = InventoryApplication.InventorySyncObservability
public typealias InventorySyncEvent = InventoryApplication.InventorySyncEvent
public typealias InventorySyncFailureCategory = InventoryApplication.InventorySyncFailureCategory
public typealias NoOpInventorySyncObservability = InventoryApplication.NoOpInventorySyncObservability
