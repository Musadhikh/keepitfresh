...
struct DataScannerPreviewView: UIViewControllerRepresentable {
    ...
    final class Coordinator: NSObject, Sendable {
        let parent: DataScannerPreviewView
        
        init(parent: DataScannerPreviewView) {
            self.parent = parent
        }
    }
}

extension DataScannerPreviewView.Coordinator: DataScannerViewControllerDelegate {}

extension DataScannerPreviewView: Sendable {}
